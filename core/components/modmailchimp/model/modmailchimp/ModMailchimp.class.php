...
require_once dirname(__FILE__).'/ModMailchimp/Folders.php';
require_once dirname(__FILE__).'/ModMailchimp/Templates.php';
require_once dirname(__FILE__).'/ModMailchimp/Users.php';
require_once dirname(__FILE__).'/ModMailchimp/Helper.php';
require_once dirname(__FILE__).'/ModMailchimp/Mobile.php';
require_once dirname(__FILE__).'/ModMailchimp/Conversations.php';
require_once dirname(__FILE__).'/ModMailchimp/Ecomm.php';
require_once dirname(__FILE__).'/ModMailchimp/Neapolitan.php';
require_once dirname(__FILE__).'/ModMailchimp/Lists.php';
require_once dirname(__FILE__).'/ModMailchimp/Campaigns.php';
require_once dirname(__FILE__).'/ModMailchimp/Vip.php';
require_once dirname(__FILE__).'/ModMailchimp/Reports.php';
require_once dirname(__FILE__).'/ModMailchimp/Gallery.php';
require_once dirname(__FILE__).'/ModMailchimp/Goal.php';
require_once dirname(__FILE__).'/ModMailchimp/Exceptions.php';
